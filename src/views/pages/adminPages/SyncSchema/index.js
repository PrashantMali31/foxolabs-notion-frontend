...
import AddPageAccess from "../../adminUserAccess/AddPageAccess";

export const Schemas = () => {
  const currentPagePath = "Schemas"
        ...
        <div className="wrapper d-flex flex-column min-vh-100 bg-light">
          ...
          <div className="body flex-grow-1 px-3">
            <div className="buttonBox p-3 " >
              <CButton color="primary" onClick={() => setVisibleAddAccess(!visibleAddAccess)}>Sync Table</CButton>
            </div>
            <div
              className="ag-theme-alpine"
              style={{height: "70vh", width: "100%"}}
            >
              <AddPageAccess visibleAddAccess={visibleAddAccess} isUser={false} setVisibleAddAccess={setVisibleAddAccess} getMapping={getMapping} />
